...
Other assumptions made with specific to the scenario are documented in the test case document.

Executing on MAC environment

Download Chrome driver and Firefox Driver for the respective browser version and copy the exe path in the SearchDataCatalog java file for the 
System.setProperty("webdriver.chrome.driver", driver exe path);
System.setProperty("webdriver.firefox.marionette", driver exe path);
